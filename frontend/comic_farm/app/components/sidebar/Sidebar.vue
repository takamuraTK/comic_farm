<template>
  <div class="flex flex-col md:flex-row">
    <div
      class="bg-gray-900 shadow-xl h-16 fixed bottom-0 mt-12 md:relative md:h-screen z-10 w-full md:w-48"
    >
      <div
    ...
    <div
      class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5 bg-gray-300"
    >
      <Nuxt class="mt-12" />
    </div>
  </div>
